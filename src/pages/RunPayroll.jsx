      ...
      <div className="p-6">
        <Card className="max-w-md mx-auto mt-12">
          <CardContent className="p-8 text-center">
            <p className="text-muted-foreground">You don't have permission to run payroll.</p>
          </CardContent>
        </Card>
      </div>
    );
        ...
        <>
          ...
          <div className="space-y-3">
            ...
            {payrollData.map(barber => (
              <Card key={barber.barber_id} className="border-border">
                <CardContent className="p-4">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <p className="font-semibold">{barber.barber_name}</p>
                      <p className="text-xs text-muted-foreground">{barber.barber_email}</p>
                      <p className="text-xs text-muted-foreground mt-1">{barber.bookings_count} completed bookings</p>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-xs">
                    <div className="bg-muted/30 rounded p-2">
                      ...
                      <p className="text-[10px] text-muted-foreground">from ${barber.service_revenue.toFixed(2)}</p>
                    </div>
                    <div className="bg-muted/30 rounded p-2">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="bg-muted/30 rounded-lg p-3">
                      ...
                      <p className="text-xl font-bold text-foreground mt-1">${grossRevenue.toFixed(2)}</p>
                      <p className="text-[10px] text-muted-foreground">all completed services</p>
                    </div>
                    <div className="bg-muted/30 rounded-lg p-3">
                      <p className="text-xs text-muted-foreground">Net Revenue</p>
                      <p className="text-xl font-bold text-[#8B9A7E] mt-1">${netRevenue.toFixed(2)}</p>
                      <p className="text-[10px] text-muted-foreground">after commissions</p>
                    </div>
                    <div className="bg-muted/30 rounded-lg p-3">
                      <p className="text-xs text-muted-foreground">Total Commission Payout</p>
                      <p className="text-xl font-bold text-foreground mt-1">${totalCommission.toFixed(2)}</p>
                      <p className="text-[10px] text-muted-foreground">service + retail</p>
                    </div>
                    <div className="bg-muted/30 rounded-lg p-3">
                    ...
                    <div className="bg-muted/30 rounded-lg p-3">
                      <p className="text-xs text-muted-foreground">Retail Commission</p>
                    ...
                    <div className="bg-muted/30 rounded-lg p-3">
                      ...
                      <p className="text-[10px] text-muted-foreground">retail only</p>
                    </div>
                    <div className="bg-muted/30 rounded-lg p-3">
                      <p className="text-xs text-muted-foreground">Retail Tax Collected</p>
                      <p className="text-lg font-semibold mt-1">${totalRetailTaxCollected.toFixed(2)}</p>
                      <p className="text-[10px] text-muted-foreground">est. avg {avgTaxRate.toFixed(1)}% rate</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
